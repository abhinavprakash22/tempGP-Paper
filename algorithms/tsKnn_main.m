function[] = tsKnn_main(turbine)  
    ...
    outfile = strcat('./intermediate_results/',turbine,'_tsKnn_results.txt');
    logfile = strcat("./intermediate_results/",turbine,"_tsKnn.log");
    fprintf('%s %s\n','Executing TS-kNN code for turbine',turbine);
